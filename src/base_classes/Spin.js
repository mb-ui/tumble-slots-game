...
export default class Spin {
    ...
    printResult() {
        ...
        //const container = this.scene.tweens.tweens[0].targets[0].list;
        if (autoSpin) {
            s1 = this.scene.data.scene.container;//autoSpin.columnTween1.targets[0];
            s2 = this.scene.data.scene.container2;//autoSpin.columnTween2.targets[0];
            s3 = this.scene.data.scene.container3;//autoSpin.columnTween3.targets[0];
            s4 = this.scene.data.scene.container4;//autoSpin.columnTween4.targets[0];
            s5 = this.scene.data.scene.container5;//autoSpin.columnTween5.targets[0];
        } else {
            s1 = this.scene.data.scene.container;//baseSpin.columnTween1.targets[0];
            s2 = this.scene.data.scene.container2;//baseSpin.columnTween2.targets[0];
            s3 = this.scene.data.scene.container3;//baseSpin.columnTween3.targets[0];
            s4 = this.scene.data.scene.container4;//baseSpin.columnTween4.targets[0];
            s5 = this.scene.data.scene.container5;//baseSpin.columnTween5.targets[0];
        }
        //push symbols name
    ...
    playWinAnim() {
        ...
        // if (sixMealManSpine.animationState.tracks[0].animation.name !== "Happy 2") {
        //     sixMealManSpine.animationState.setAnimation(0, "Happy 2", true);
        // }
    }
    audioPlayLose() {
        if (this.scene.audioMusicName === 'btn_music.png') {
    ...
    playLoseAnim() {
        ...
        //     sixMealManSpine.animationState.setAnimation(0, "Idle Sad", true);
        // }
    }
    getMoney(money) {
